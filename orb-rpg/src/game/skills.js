...
export const ABILITIES = {
  ...
  'blade_storm': { id:'blade_storm', type:'active', name:'Blade Storm', category:'Weapons - Melee', targetType:'area', mana:22, cd:9.5, castTime:0.4, range:0, radius:18, target:'Self AoE', desc:'Spin and shred around you.', details:'3s spinning storm hitting nearby enemies repeatedly.', scaling:'Attack Power: 150%', icon:'add to ability with poison.png' },
