...
export const KEYBIND_VERSION = 12; // Increment to force keybind reset
...
export const DEFAULT_BINDS = {
  ...
  toggleHud:'KeyB',
  downloadLogs:'Backquote',
  toggleDebugLogs:'Equal',
...
export const ACTION_LABELS = {
  ...
  loadout1:'Load Ability Loadout 1', loadout2:'Load Ability Loadout 2', loadout3:'Load Ability Loadout 3',
  tabInventory:'Open Inventory Tab', tabSkills:'Open Skills Tab', tabLevel:'Open Level Tab', tabBuffs:'Open Buffs Tab', tabGroup:'Open Group Tab', tabAllies:'Open Allies Tab', tabCampaign:'Open Campaign Tab',
  toggleHud:'Toggle HUD Visibility',
  downloadLogs:'Download All Selected Logs',
  toggleDebugLogs:'Toggle All Debug Logs',
